...
document.getElementById('btn-reset').addEventListener('click', () => { if(confirm("Recommencer à zéro ?")) { localStorage.removeItem('sauvegardeGen1'); localStorage.removeItem('timerGen1'); location.reload(); } });
